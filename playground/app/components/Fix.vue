...
<template>
  ...
  <!-- prettier-ignore -->
  <div class="w-full w-fit w-auto w-1 w-2 w-3 w-4 w-6 w-8 w-10 w-12 w-16 w-20 w-24 w-32 w-40 w-48 w-56 w-64 w-96 w-128 w-256 lg:w-1 lg:w-2 lg:w-3 lg:w-4 lg:w-6 lg:w-8 lg:w-10 lg:w-12 lg:w-16 lg:w-20 lg:w-24 lg:w-32 lg:w-40 lg:w-48 lg:w-56 lg:w-64 lg:w-96 lg:w-128 lg:w-256"/>
  <!-- prettier-ignore -->
